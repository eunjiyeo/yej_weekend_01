...
> 직계 포함 관계에서만 부모요소, 자식요소
> 직계가 아닌 포함관계에서는 조상(Ancestor)요소, 자손요소(decendant)
...
> id/class naming, 클래스/변수/함수 naming, 파일/폴더 naming의 경우 가독성을 높이기 위해 사용
>
...
> RGB => 3byte => 24bit 트루컬러 : 1677126가지
> 
...
>   - 순서대로 대체 폰트를 찾음
>   - sans-aerif, serif, monospace, cursive, fantasy 5개의 기본 폰트는 font-family 사용시 종류에 맞게 항상 끝에 기본으로 사용됨.
